...
def plot_uav_altitudes(alluav: list):
    """Gera gráfico das altitudes dos UAVs"""
    try:
        # Extrair dados dos UAVs
        uav_ids = [f"UAV {i+1}" for i in range(len(alluav))]
        altitudes = [uav.H for uav in alluav]
        ...
        plt.title('Altitudes dos UAVs - Greedy', fontsize=14, fontweight='bold')
        ...
        print("Gráfico das altitudes dos UAVs gerado com sucesso!")
        
    except Exception as e:
        print(f"Erro ao gerar gráfico das altitudes: {str(e)}")
...
def main():
    ...
    # Gerar gráfico das altitudes dos UAVs
    plot_uav_altitudes(alluav)
